...
public class PharFrame extends IFrame {
    Dimension screen;
    ObjectData objectData;
    PharOPDPanel pharOPDPanel;
    public PharFrame(int w,int h) {
        super();
        setBounds(0, 0, w, h);
        setPreferredSize(new Dimension(w, h));
        setTitle(Prop.getProperty("module.name.phar"));
        setLocation(0, 0);
        //setClosable(true);
        //setIconifiable(true);
        //setMaximizable(true);
        objectData = new ObjectData();
        pharOPDPanel = new PharOPDPanel(objectData,getBounds().width,getBounds().height);
