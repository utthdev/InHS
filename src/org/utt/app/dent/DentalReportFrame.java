...
public class DentalReportFrame  extends IFrame{
	Dimension screen;
	DentalReportPanel dentalReportPanel;
	ObjectData objectData;
	
	public DentalReportFrame(int w,int h) {
		super();
        ...
        dentalReportPanel = new DentalReportPanel(objectData,getBounds().width,getBounds().height);
        objectData.addObserver(dentalReportPanel);
