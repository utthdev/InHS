...
public class MedReconPanel extends WebPanel implements Observer{
    ...
    public MedReconPanel(ObjectData oUserInfo, int w, int h) {
		...
		ButtonPrint.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(line_med_opd.equals("")&& line_med_ipd.equals("")&& line_ipd.equals("")&& line_opd.equals("")) {
	        ...
	        while (rs.next()) {
	        	...
	        	while (rs1.next()) {
		        	...
		        	*/
	        		...
	        		System.out.println("..."+drug+" "+dt+" "+dqc+" "+duc+" "+dc+" "+aux3+" "+dmemo+" "+ned);
	        	}
	...
	public WebTreeModel getDefaultTreeModelIPD (String hn){
		...
		//String query_ipd =  "select an from admmaster where  hn=? order by admdatetime desc ";
	        ...
	        while (rs2.next()) {
				...
				while (rs3.next()) {
					 if(rs3.getString(1) !=null) {
						...
						String qu="select an ,stockcode,qty,dosecode,dosetype,doseunitcode,doseqtycode,auxlabel1,auxlabel2,auxlabel3,makedatetime from ipddrughist where  orderno='"+orderno+"'";
						
						stmt4 = conn.prepareStatement(qu);
						ResultSet rs4 = stmt4.executeQuery();
						while (rs4.next()) {
							String drug="",ned="",dc="",dt="",dqc="",aux="",aux2="",aux3="",duc="",q="",dcdate="";
				        	...
				        	*/
							...
							parent.add( new UniqueNode (drug+ " "+dt+" "+dqc+" "+duc+" "+dc));
